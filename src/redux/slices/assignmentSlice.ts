import {CREATE_ASSIGNMENT, GET_COMING_ASSIGNMENTS_BY_USER_ID, UPLOAD_SUBMISSIONS} from '@config/api'
...
export const createAssignment = createAsyncThunk(
    ...
    async (data: {
        ...
        startTime: string,
        endTime: string,
        attachmentKeys: { key: string, name: string }[]
    }) => await cloud.invoke(CREATE_ASSIGNMENT, data)
)
